                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      ...
                      {(() => {
                        const kalendarAssigned = getKalendarAssignedLingkungan(
                          formData.date
                        );
                        const assignedLingkungan = lingkunganData.filter(
                          (ling) => kalendarAssigned.has(ling.namaLingkungan)
                        );
                        const notAssignedLingkungan = lingkunganData.filter(
                          (ling) => !kalendarAssigned.has(ling.namaLingkungan)
                        );
